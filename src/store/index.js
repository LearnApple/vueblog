      ...
      LISTDATA ({ commit, state }) {
        ...
        switch (name) {
          ...
          case 'category':
            ...
            var id1 = state.route.params.page || ''
            return bytagdata(tag, id1)
          ...
          case 'archive':
            ...
            var id2 = state.route.params.page || ''
            return byarchivedata(date, id2)
          ...
          case 'search':
            ...
            var id3 = state.route.params.page
            return searchdata(info, id3)
